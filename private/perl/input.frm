...
Development extension|DEV_EXTENSION|T||html
Logs||S||
...
Session timeout template|SESSION_TIME_OUT_TEMPLATE|T||timeout.html
...
Access denied template|SECURITY_ACCESS_DENIED_TEMPLATE|T||denied.html
